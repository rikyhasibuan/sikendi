...
export default {
    ...
    methods: {
        ...
        onChangePpn(evt) {
            //console.log(evt);
            //this.sp2t.nominal_transfer = this.sp2t.nominalbruto - evt;
        },
        onChangePph21() {
        ...
        onChangeProgram(evt) {
            ...
            let url = '';
            if (this.usernip != 'admin') {
                url = '../api/ajax/kegiatan?bendahara='+this.usernip+'&program=' + program;
            } else {
                url = '../api/ajax/kegiatan?program=' + program;
            }
